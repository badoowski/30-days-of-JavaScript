...
/*
    Question 2:  A junior developer structure student name, skills and score in array of arrays which may not easy to read. Destructure 
    the following array name to name, skills array to skills, scores array to scores, JavaScript score to jsScore and React score to 
...
const convertArrayToObject = (array) => {
  ...
  for (const elem in array) {
    let [name, skills, scores] = array[elem];
...
/*
    Question 3: Copy the student object to newStudent without mutating the original object. In the new object add the following ?
